...
Color-coded console output + plain file logging for the dashboard/runtime monitor.
"""
...
from runtime_state import LOG_FILE, ensure_runtime_root
...
def setup_logging(verbose: bool = False):
    """Configure logging for both terminal output and dashboard log tailing."""
    ensure_runtime_root()
    console_handler = logging.StreamHandler(sys.stdout)
    console_handler.setFormatter(HarnessFormatter())
